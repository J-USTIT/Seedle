    ...
    return (
        <nav className="bg-white/80 backdrop-blur-md border-b border-emerald-100 p-4 sticky top-0 z-50 shadow-sm animate-fade-in-up">
            <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between">
                <div className="font-bold text-emerald-800 text-xl">BSeedle</div>
                <button 
                ...
                <div className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row w-full md:w-auto gap-4 items-center mt-4 md:mt-0`}>
                    {children}
                </div>
            </div>
        </nav>
