            ...
            <div className="w-full max-w-[1200px] bg-[#FCF9F2]/90 backdrop-blur-xl rounded-[2rem] shadow-[0_20px_40px_-15px_rgba(46,125,50,0.1)] border border-white/50 p-6 sm:p-10 relative overflow-hidden mt-8">
                ...
                <div className="relative z-10">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-8 gap-4">
                        <div>
                            <h1 className="text-4xl md:text-5xl font-semibold text-emerald-900 tracking-tight mb-2">Dictionary</h1>
                            <p className="text-emerald-700/70 text-sm font-medium">Explore the complete botanical database</p>
                        </div>
